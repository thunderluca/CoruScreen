...
export class BrowserRequirement {
    ...
    public static DEFAULT: BrowserRequirement[] = [
        ...
        { displayName: 'Microsoft Edge', feature: 'app', names: ['edge', 'microsoft edge'], operatingSystems: [OperatingSystem.Android, OperatingSystem.Linux, OperatingSystem.MacOS, OperatingSystem.Windows], platforms: [DevicePlatform.Any], version: '79' },
        { displayName: 'Mozilla Firefox', feature: 'app', names: ['firefox', 'mozilla firefox'], operatingSystems: [OperatingSystem.Android], platforms: [DevicePlatform.Mobile, DevicePlatform.Tablet, DevicePlatform.TV], version: '86' },
        ...
        { displayName: 'Microsoft Edge', feature: 'permissions', names: ['edge', 'microsoft edge'], operatingSystems: [OperatingSystem.Android, OperatingSystem.Linux, OperatingSystem.MacOS, OperatingSystem.Windows], platforms: [DevicePlatform.Any], version: '79' },
